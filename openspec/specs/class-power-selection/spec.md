# Spec: Class Power Selection

## Purpose

Defines the requirements for selecting, stacking, and managing class power ranks during character creation in Fabula Creator across web and CLI interfaces.
